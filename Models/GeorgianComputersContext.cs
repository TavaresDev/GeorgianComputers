...
{
        //modify the DbContect to handle the user identitien and roles
        //the last parameter idicate the PK od userId values as a string
...
//                optionsBuilder.UseSqlServer("Data Source=ANDREDELL\\SQLSERVER2019;Initial Catalog=GeorgianComputers;Integrated Security=True");
            }
        }
